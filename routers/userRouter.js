...
const  { logIn, signUp, getOneUser, signOut, verifyOTP, forgotPassword, resetPassword, resendOTP, sign_up_with_google}  = require("../controllers/userControls")
...
userRouter.get('/google-signup', sign_up_with_google);
